...
handler = logging.FileHandler('/Users/sanilparmar/Desktop/multi_agent_ai_system/logs/email_agent.log', "w")
...
class EmailExtractionResult(BaseModel):
    ...
    extracted_summary: str = Field(description="Short summary extracted from the email")
...
4. Provide a short summary of the email content
...
def extract_email_info(email_text: str) -> EmailExtractionResult:
    ...
    try:
        ...
        return EmailExtractionResult(
            ...
            confidence=0.0,
            extracted_summary="Extraction failed. See logs for more info."
        )
